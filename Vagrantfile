...
#  config.vm.network :forwarded_port, guest: 80, host: 8080
  ...
  #config.vm.synced_folder ".", "/vagrant" # VirtualBox shared directory workaround
  config.vm.synced_folder ".", "/vagrant", type: "nfs", nfs_udp: "true", nfs_version: "4"
 


  # Set the virtual machine host name
  config.vm.hostname = "menta-test"
